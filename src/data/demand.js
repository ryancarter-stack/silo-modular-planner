...
export const retailer = {
  ...
  functions: [
    ...
    { id: 'purchasing', name: 'Purchase Orders', siloStatus: true, famousStatus: true, famousModule: 'Purchase Orders', famousPrice: 1500, description: 'Procurement for retail produce needs. Generates purchase orders based on demand forecasts and inventory position. Manages standing orders and promotional buys. Coordinates with vendors on delivery schedules and quantities.' },
    { id: 'receiving', name: 'Receiving', siloStatus: true, famousStatus: true, famousModule: 'Inventory', famousPrice: 1000, description: 'Store or distribution center receiving. Verifies deliveries against orders, checks quality and temperature. Documents discrepancies and quality issues. Processes receiving for inventory and payables.' },
    { id: 'inventory-mgmt', name: 'Inventory Management', siloStatus: true, famousStatus: true, famousModule: 'Inventory', famousPrice: 1000, description: 'Produce inventory management focused on freshness and availability. Tracks inventory levels, rotation, and shrink. Supports perpetual inventory and cycle counting. Provides data for ordering and merchandising decisions.' },
    { id: 'shrink-tracking', name: 'Shrink Tracking', siloStatus: true, famousStatus: true, famousModule: 'Inventory', famousPrice: 1000, description: 'Detailed shrink measurement and analysis. Categorizes shrink by cause (spoilage, damage, theft, markdown). Tracks shrink by item, department, and store. Supports shrink reduction initiatives and vendor quality feedback.' },
    { id: 'pricing-retail', name: 'Pricing (Retail)', siloStatus: true, famousStatus: true, famousModule: 'Price List Maintenance', famousPrice: 1000, description: 'Retail pricing management including everyday prices, promotions, and markdowns. Manages price changes and ensures compliance. Supports promotional pricing and ad planning. Integrates with POS systems for price updates.' },
    { id: 'ap-billpay', name: 'AP / Bill Pay', siloStatus: true, famousStatus: true, famousModule: 'Accounts Payable', famousPrice: 1000, description: 'Vendor invoice processing and payment. Matches invoices to receiving and purchase orders. Manages payment terms and deductions. Processes payments according to vendor agreements.' },
    ...
    { id: 'traceability', name: 'Traceability', siloStatus: true, famousStatus: true, famousModule: 'Grower Lots', famousPrice: 1000, description: 'Product traceability for recall management and consumer inquiries. Links product to suppliers through lot codes. Supports rapid recall response and affected product identification. Maintains records meeting FDA requirements.' },
    { id: 'ordering', name: 'Ordering', siloStatus: true, famousStatus: true, famousModule: 'Sales Orders', famousPrice: 2000, description: 'Store-level ordering for produce replenishment. Generates orders based on movement, forecasts, and planned promotions. Supports automated replenishment and manual adjustments. Coordinates with distribution for delivery scheduling.' },
...
export const restaurant = {
  ...
  functions: [
    ...
    { id: 'purchasing', name: 'Purchasing', siloStatus: true, famousStatus: true, famousModule: 'Purchase Orders', famousPrice: 1500, description: 'Produce procurement for restaurant operations. Places orders with vendors based on menu needs and par levels. Manages standing orders and special requests. Coordinates delivery timing with restaurant hours.' },
    { id: 'receiving', name: 'Receiving', siloStatus: true, famousStatus: true, famousModule: 'Inventory', famousPrice: 1000, description: 'Delivery receiving and verification. Checks quality, quantities, and temperatures on receipt. Documents any issues for vendor follow-up. Processes receiving for inventory and payment.' },
    { id: 'inventory-mgmt', name: 'Inventory Management', siloStatus: true, famousStatus: true, famousModule: 'Inventory', famousPrice: 1000, description: 'Kitchen inventory management for produce items. Tracks on-hand quantities, usage, and waste. Supports FIFO rotation and freshness management. Provides data for ordering and food cost control.' },
    ...
    { id: 'ap-billpay', name: 'AP / Bill Pay', siloStatus: true, famousStatus: true, famousModule: 'Accounts Payable', famousPrice: 1000, description: 'Vendor invoice processing and payment management. Reconciles invoices with receipts and orders. Manages payment terms and timing. Processes payments to maintain vendor relationships.' },
    { id: 'waste-tracking', name: 'Waste Tracking', siloStatus: true, famousStatus: true, famousModule: 'Inventory', famousPrice: 1000, description: 'Food waste monitoring for produce items. Tracks waste by cause (spoilage, overproduction, trim). Calculates waste costs and trends. Supports waste reduction initiatives and sustainability reporting.' },
    { id: 'ordering', name: 'Ordering', siloStatus: true, famousStatus: true, famousModule: 'Sales Orders', famousPrice: 2000, description: 'Regular ordering to maintain produce inventory. Generates orders based on par levels, usage, and upcoming needs. Supports order guides and standing orders. Coordinates with vendors on delivery schedules.' },
...
export const institution = {
  ...
  functions: [
    ...
    { id: 'receiving', name: 'Receiving', siloStatus: true, famousStatus: true, famousModule: 'Inventory', famousPrice: 1000, description: 'Institutional receiving with documentation requirements. Verifies deliveries against contracts and orders. Maintains receiving records for audit compliance. Documents quality and delivery performance.' },
    { id: 'inventory-mgmt', name: 'Inventory Management', siloStatus: true, famousStatus: true, famousModule: 'Inventory', famousPrice: 1000, description: 'Large-scale inventory management for institutional operations. Tracks inventory across multiple storage locations. Supports FIFO rotation and usage tracking. Provides data for ordering and cost control.' },
    ...
    { id: 'ap-billpay', name: 'AP / Bill Pay', siloStatus: true, famousStatus: true, famousModule: 'Accounts Payable', famousPrice: 1000, description: 'Institutional payables processing with approval workflows. Manages invoice verification and approval routing. Processes payments according to contract terms. Maintains audit trail for financial compliance.' },
    { id: 'reporting', name: 'Reporting', siloStatus: true, famousStatus: true, famousModule: 'Report Administration', famousPrice: 1000, description: 'Operational and compliance reporting for institutional stakeholders. Generates spend analysis, vendor performance, and compliance reports. Supports budget tracking and cost analysis. Provides data for management decision-making.' },
  ],
};
...
export const manufacturer = {
  ...
  functions: [
    ...
    { id: 'purchasing', name: 'Purchasing', siloStatus: true, famousStatus: true, famousModule: 'Purchase Orders', famousPrice: 1500, description: 'Raw material procurement for manufacturing operations. Manages purchase orders, contracts, and scheduling. Coordinates supply with production requirements. Supports both spot buying and program purchasing.' },
    ...
    { id: 'receiving', name: 'Receiving', siloStatus: true, famousStatus: true, famousModule: 'Inventory', famousPrice: 1000, description: 'Incoming material receiving with quality protocols. Verifies shipments against orders and specifications. Samples for quality testing and records receipt data. Manages hold-and-release procedures for raw materials.' },
    { id: 'quality-inbound', name: 'Quality Inspection', siloStatus: false, famousStatus: true, famousModule: 'Inventory', famousPrice: 1000, description: 'Raw material quality verification before production use. Performs specified tests and inspections. Documents quality results and maintains records. Manages non-conforming material and supplier feedback.' },
    { id: 'inventory-raw', name: 'Inventory (Raw Materials)', siloStatus: true, famousStatus: true, famousModule: 'Inventory', famousPrice: 1000, description: 'Raw material inventory management for production support. Tracks ingredient inventory, lot numbers, and expiration. Supports production scheduling and material planning. Manages storage conditions and rotation.' },
    { id: 'lot-traceability', name: 'Lot Traceability', siloStatus: true, famousStatus: true, famousModule: 'Grower Lots', famousPrice: 1000, description: 'Ingredient traceability through manufacturing. Links raw material lots to finished products. Supports recall readiness and regulatory compliance. Generates traceability documentation for audits and customer requests.' },
    { id: 'ap-billpay', name: 'AP / Bill Pay', siloStatus: true, famousStatus: true, famousModule: 'Accounts Payable', famousPrice: 1000, description: 'Supplier invoice processing and payment. Manages invoice verification, approval workflows, and payment processing. Tracks payables by supplier and commodity. Supports early payment programs and vendor terms management.' },
