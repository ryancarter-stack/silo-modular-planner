...
export const coldStorage = {
  ...
  functions: [
    ...
    { id: 'receiving', name: 'Receiving', siloStatus: true, famousStatus: true, description: 'Inbound receiving on behalf of depositors. Processes appointments, inspects loads, and documents receipt details. Creates inventory records linked to depositor accounts. Manages receiving labor and dock scheduling.' },
    { id: 'quality-inspection', name: 'Quality Inspection (Receiving)', siloStatus: false, famousStatus: true, description: 'Quality assessment on receipt for depositor accountability. Documents product condition, temperature, and any damage or quality issues. Captures photos and detailed notes. Provides inspection reports to depositors for supplier claims and inventory valuation.' },
    { id: 'inventory-3pl', name: 'Inventory Management (Multi-owner)', siloStatus: true, famousStatus: true, description: 'Multi-customer inventory tracking within the facility. Maintains accurate inventory by depositor, lot, and location. Supports customer inventory inquiries and reporting. Manages inventory accuracy through cycle counting.' },
    { id: 'warehouse-mgmt', name: 'Warehouse Operations', siloStatus: true, famousStatus: true, description: 'Facility operations including putaway, storage, picking, and shipping. Optimizes space utilization and labor efficiency. Manages temperature zones and product segregation. Tracks operational productivity and costs.' },
    ...
    { id: 'order-fulfillment', name: 'Order Fulfillment', siloStatus: true, famousStatus: true, description: 'Customer order processing and fulfillment. Receives orders from depositors, picks inventory, and prepares shipments. Manages order priorities and shipping schedules. Tracks fulfillment accuracy and timeliness.' },
    { id: 'shipping', name: 'Shipping', siloStatus: true, famousStatus: true, description: 'Outbound shipping coordination and execution. Manages carrier appointments, load building, and BOL generation. Coordinates with carriers and tracks shipments. Provides shipping documentation to depositors.' },
    { id: 'billing-storage', name: 'Billing (Storage & Handling)', siloStatus: false, famousStatus: true, description: 'Service billing for storage, handling, and value-added services. Calculates charges based on rate agreements and activity. Generates detailed invoices with transaction support. Manages billing cycles and customer-specific requirements.' },
    { id: 'ar-collections', name: 'AR / Collections', siloStatus: true, famousStatus: true, description: 'Service fee receivables management. Tracks customer payments and manages collection activities. Coordinates with customers on billing questions. Maintains cash flow visibility for the facility.' },
    ...
    { id: 'customer-reporting', name: 'Customer Reporting', siloStatus: false, famousStatus: true, description: 'Inventory and activity reporting for depositors. Provides real-time inventory visibility, transaction history, and aging reports. Supports customer-specific reporting requirements. Enables customer self-service access to their data.' },
    { id: 'lot-traceability', name: 'Lot Traceability', siloStatus: true, famousStatus: true, description: 'Product traceability through cold storage operations. Maintains lot identity from receiving through shipping. Supports customer recall requirements and regulatory compliance. Generates traceability documentation.' },
  ],
};
...
export const trucking = {
  ...
  functions: [
    ...
    { id: 'ar-collections', name: 'AR / Collections', siloStatus: true, famousStatus: true, description: 'Freight receivables management. Tracks customer payments and manages collection activities. Handles billing disputes and deduction management. Maintains cash flow visibility for the trucking operation.' },
...
export const qcInspection = {
  ...
  functions: [
    ...
    { id: 'reporting', name: 'Report Generation', siloStatus: false, famousStatus: true, description: 'Inspection report creation and distribution. Generates detailed reports with findings, grades, and photos. Delivers reports to clients in required formats. Maintains report archives for future reference.' },
    ...
    { id: 'billing-inspection', name: 'Billing (Inspection Services)', siloStatus: false, famousStatus: true, description: 'Service billing for inspections and related services. Calculates charges based on inspection type, volume, and location. Generates invoices and manages billing cycles. Supports various billing arrangements and client-specific requirements.' },
    { id: 'ar-collections', name: 'AR / Collections', siloStatus: true, famousStatus: true, description: 'Inspection fee receivables management. Tracks client payments and manages collection activities. Handles billing inquiries and disputes. Maintains cash flow visibility for the inspection business.' },
  ],
};
